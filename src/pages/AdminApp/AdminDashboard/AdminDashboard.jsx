...
const TaxaCancelamentosChart = ({ data }) => {
  console.log("TaxaCancelamentosChart recebeu data:", data);
...
const ConsultasPorMedicoChart = ({ data }) => {
  console.log("ConsultasPorMedicoChart recebeu data:", data);
...
function AdminDashboard() {
  ...
  const processConsultasPorMedico = async (appointmentsData, doctorsData) => {
    try {
      ...
      console.log("Debug - doctorsData:", doctorsData);
      ...
      console.log("Debug - doctorsMap:", doctorsMap);
      ...
      console.log("Debug - consultasPorMedico:", consultasPorMedico);
