...
function MinhasConsultas() {
  ...
  useEffect(() => {
    fetch(`https://yuanqfswhberkoevtmfr.supabase.co/rest/v1/appointments?patient_id=eq.${patient_id}`, requestOptions)
    ...
    <div className="content">
      <div className="row">
        ...
        <div className="col-sm-8 col-9 text-right m-b-20">
          <Link to="/patientapp/marcarconsulta" className="btn btn-primary btn-rounded">
            <i className="fa fa-plus"></i> Marcar Consulta
          </Link>
        </div>
      </div>
